...
if((os.path.isfile("corpus.txt")!=True)):
   print ("Downloading corpus.txt as it doesn't exist in directory.")
   id="1rI79RgJx2ZajOGtYsw-kxCjrr2VUYH1e"
...
if(int(download_embed)==1):
   print ("Downloading cbow_embed.npy as it is the choice.")
...
if ((os.path.isfile("dictionary.npy")==True) & (os.path.isfile("reverse_dictionary.npy")==True) & (os.path.isfile("words.npy")==True)):
    print("The corpus will not be processed for tokenization as it is found that earlier processed files available.")
else:
...
if ((os.path.isfile("dictionary.npy")==True) & (os.path.isfile("reverse_dictionary.npy")==True) & (os.path.isfile("data.npy")==True)):
    print("The corpus will not be processed as dictionary, sequencing has been already processed in earlier run.")
else:
